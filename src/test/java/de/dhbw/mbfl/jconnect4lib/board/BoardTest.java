...
//    }
    ...
    public void testDeterminePossiblePositions() {
        ...
        assertEquals(7, possiblePositions.size());
        possiblePositions.remove(new Position(0, 3));
        possiblePositions.remove(new Position(1, 1));
        possiblePositions.remove(new Position(2, 1));
        possiblePositions.remove(new Position(3, 1));
        possiblePositions.remove(new Position(4, 0));
        possiblePositions.remove(new Position(5, 0));
        possiblePositions.remove(new Position(6, 0));
